...
public class SmWfv {
	...
	private static final Logger log = LoggerFactory.getLogger(SmWfv.class);
	...
	public void addSmWfv(Value value)
	...
	public void getSmWfv(String xmlString) throws IOException {
		...
		log.info("The soil moisture value of the sensor with id: " + responseValue.getId() + " is: "
