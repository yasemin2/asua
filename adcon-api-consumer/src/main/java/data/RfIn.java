...
public class RfIn {
	...
	private static final Logger log = LoggerFactory.getLogger(RfIn.class);
	...
	public void addRfIn(Value value)
	...
	public void getRfIn (String xmlString) throws IOException {
		...
		log.info("The rf in value of the sensor with id: " + responseValue.getId() + " is: "
