...
public class PowerOutput {
	...
	private static final Logger log = LoggerFactory.getLogger(PowerOutput.class);
	...
	public void addPowerOutput(Value value)
	...
	public void getPowerOutput (String xmlString) throws IOException {
		...
		log.info("The power output value of the sensor with id: " + responseValue.getId() + " is: "
