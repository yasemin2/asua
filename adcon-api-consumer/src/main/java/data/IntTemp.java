...
public class IntTemp {
	...
	private static final Logger log = LoggerFactory.getLogger(IntTemp.class);
	...
	public void addIntTemp(Value value)
	...
	public void getIntTemp (String xmlString) throws IOException {
		...
		log.info("The internal temperature value of the sensor with id: " + responseValue.getId() + " is: "
