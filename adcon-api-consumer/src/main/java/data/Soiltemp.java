...
public class Soiltemp {
	...
	private static final Logger log = LoggerFactory.getLogger(Soiltemp.class);
	...
	public void addSoiltemp(Value value)
	...
	public void getSoiltemp(String xmlString) throws IOException {
		...
		log.info("The soil temperature value of the sensor with id: " + responseValue.getId() + " is: "
