...
public class Temp {
	...
	public void addTemp(Value value)
	...
	public void getTemp (String xmlString) throws IOException {
		...
		log.info("The temperature value of the sensor with id: " + responseValue.getId() + " is: "
