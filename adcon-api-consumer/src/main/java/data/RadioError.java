...
public class RadioError {
	...
	public void addRadioError(Value value)
	...
	public void getRadioError (String xmlString) throws IOException {
		...
		log.info("The radio error value of the sensor with id: " + responseValue.getId() + " is: "
