...
public class RfOut {
	...
	private static final Logger log = LoggerFactory.getLogger(RfOut.class);
	...
	public void addRfOut(Value value)
	...
	public void getRfOut (String xmlString) throws IOException {
		...
		log.info("The rf out value of the sensor with id: " + responseValue.getId() + " is: "
