...
public class SolarCell {
	...
	private static final Logger log = LoggerFactory.getLogger(SolarCell.class);
	...
	public void addSolarCell(Value value)
	...
	public void getSolarCell (String xmlString) throws IOException {
		...
		log.info("The charging regulator value of the sensor with id: " + responseValue.getId() + " is: "
